      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-300 mb-6">
            This page shows your A/B testing system in action. Each time you
            refresh, you might see different variants based on your user
            assignment.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="bg-gray-700 p-3 rounded">
                ...
                <p className="text-gray-400">
                  In test: {ctaTest.isInTest ? "Yes" : "No"}
                </p>
              </div>
              <div className="bg-gray-700 p-3 rounded">
                ...
                <p className="text-gray-400">
                  In test: {heroTest.isInTest ? "Yes" : "No"}
                </p>
              </div>
              <div className="bg-gray-700 p-3 rounded">
                ...
                <p className="text-gray-400">
                  In test: {leadTest.isInTest ? "Yes" : "No"}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-12">
          ...
          <section className="bg-gray-900 p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-orange-400 mb-6">
              1. Book Purchase Button Test
            </h2>
            <p className="text-gray-300 mb-6">
              Testing different button text to see what drives more clicks. Your
              variant:{" "}
          ...
          <section className="bg-gray-900 p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-orange-400 mb-6">
              2. Homepage Hero Layout Test
            </h2>
            <p className="text-gray-300 mb-6">
              Testing video vs book covers in hero section. Your variant:{" "}
              <span className="font-bold text-green-400">
                {heroTest.variant}
              </span>
            </p>
          ...
          <section className="bg-gray-900 p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-orange-400 mb-6">
              3. Lead Magnet Form Test
            </h2>
            <p className="text-gray-300 mb-6">
              Testing different form copy and layouts. Your variant:{" "}
              <span className="font-bold text-green-400">
                {leadTest.variant}
              </span>
            </p>
        ...
        <div className="mt-12 bg-blue-900/30 p-6 rounded-lg border border-blue-500/50">
          <h3 className="text-xl font-bold text-blue-200 mb-4">
            How to See Different Variants:
          </h3>
          <div className="text-blue-100 space-y-2">
            <p>
              <strong>1. Click &quot;Reset User&quot;</strong> - This clears
              your user ID and assigns you to a new test group
            </p>
            <p>
              <strong>2. Refresh the page</strong> - You might see different
              button text, layouts, or form copy
            </p>
            <p>
              <strong>3. Try multiple times</strong> - The system uses
              statistical distribution, so you’ll see different variants
            </p>
            <p>
              <strong>4. Check the dashboard</strong> - See which tests are
              active and their configuration
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 bg-yellow-900/30 p-6 rounded-lg border border-yellow-500/50">
          ...
          <div className="text-yellow-100 space-y-3">
            <p>
              To activate these tests on your real site, simply replace the
              existing components:
            </p>
            <div className="bg-gray-800 p-4 rounded mt-4 font-mono text-sm">
              <p className="text-green-400">
                {/* In your book pages, replace: */}
              </p>
              ...
              <p className="text-gray-300">
                {
                  "<BookCTATest purchaseLink={book.purchaseLink} bookTitle={book.title} />"
                }
              </p>
            </div>
          </div>
