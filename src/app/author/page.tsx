    ...
    <>
        ...
        <div className="relative overflow-hidden grid grid-cols-1 md:grid-cols-[2fr_1fr] lg:grid-cols-[1fr_400px] items-center">
          <div className="space-y-5 ">
            ...
            <div
              ...
              <p>
                She grew up on a steady diet of Goosebumps, flashlight-under-the-blanket nights, and the kind of creepy books you read even though you&apos;re not supposed to. Now she writes stories
                that make you shiver, smile, and check the closet one more time… just in case.
              </p>
              <p>She lives with her family, a growing hoard of horror paperbacks, and probably a ghost dog.</p>
              <p>
                When she&apos;s not writing, she&apos;s lifting heavy things, drinking coffee on her porch like a cryptid in training, or plotting how to turn <i className="font-bold">Scaremoor</i>{" "}
                into an entire universe of middle grade horror that keeps kids (and adults) delightfully disturbed.
              </p>
            </div>
          </div>
      ...
      <main className=" text-white relative overflow-hidden px-8">
        ...
        <section className="relative flex flex-col justify-center items-center text-center space-y-12 h-180 z-50">
          <h2 className="font-(family-name:--trickOrDead) font-normal  text-4xl md:text-7xl text-center">
            Want to ask her a question <span className="block bg-gradient-to-b from-white from-[10%] to-[#A4A4A4] bg-clip-text text-transparent">or share a spooky idea?</span>
          </h2>
