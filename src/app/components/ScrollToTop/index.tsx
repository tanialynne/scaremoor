...
export default function ScrollToTop() {
  ...
  // Hide scroll-to-top button on worksheet pages
  const isWorksheetPage = pathname.includes('/worksheets/') && (
    pathname.includes('/fun-activities/') ||
    pathname.includes('/online/grade/')
  );
