  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto relative w-full">
        <div className="absolute -top-16 -left-6 md:-top-20 md:-left-12 -rotate-18 z-40">
          <Button
            buttonImage={YellowTag}
            altText="join-club-tag"
            text="Join The"
        ...
        <div className="space-y-5 relative z-50">
          ...
          >
            <p>
              Want secret stories, creepy wallpapers, and insider-only chills?
            </p>
            <p>
        ...
        <div className="absolute bottom-0 right-0">
          ...
          <Image
            src={BatImage}
            alt="bat"
            className="absolute top-80 -left-30 -rotate-60"
          />
        </div>
      </div>
    </section>
