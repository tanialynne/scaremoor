  ...
  return (
    <section
      ...
      <div className="space-y-6 text-center relative z-50">
        {title && (
          <h2 className="font-(family-name:--trickOrDead) font-normal text-4xl sm:text-6xl capitalize bg-gradient-to-b from-white from-[10%] to-[#A4A4A4] bg-clip-text text-transparent">{title}</h2>
        )}
