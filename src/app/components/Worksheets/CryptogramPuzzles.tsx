        ...
        >
          ...
          >
            ...
            <div className="text-gray-700 space-y-2">
              <p className="text-sm">
                <strong>1. Read the cipher type:</strong> Each puzzle tells you what kind of code is used (like Caesar Cipher).
              </p>
              <p className="text-sm">
                <strong>2. Study the pattern:</strong> Look at the encoded message and think about letter patterns.
              </p>
              <p className="text-sm">
                <strong>3. Use the hint:</strong> The 💡 hint gives you a clue about the message.
              </p>
              <p className="text-sm">
